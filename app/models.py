...
#        ('CANELA - CATEDRAL', 'CANELA - CATEDRAL'),
    ...
    BRINDE_CHOICES = [
        ...
        ('BG - VINHO PIZZATO - MERLOT', 'BG - VINHO PIZZATO - MERLOT'),
    ...
    def descricao_brinde1(self):
        if self.Brinde == 'GM - RESTAURANTE LAGHETTO':
            ...
            return '#ESTE VOUCHER DA DIREITO AO CONSUMO DE R$: 50,00 NA NBA STORE, LOJA OFICIAL DA NBA.'
        elif self.Brinde == 'GM - FOTO DIGITAL LOJA FOREVER IN GRAMADO':
            return '# ESTE VOUCHER DA DIREITO A UMA FOTO DIGITAL COM LOOK NA CABINE TELEFÔNICA DE LONDRES - LOJA FOREVER IN GRAMADO.\n\n \
                    # ESTE VOUCHER DA DIREITO A 10% DE DESCONTO NO ALUGUEL DE QUALQUER ITEM NA LOJA AIRCLOSET.\n \n \
                    # ENDEREÇO: RUA GARIBALDE 180, SALA 04 (EM FRENTE AO SERRA AZUL). '
            ...
            return '# VALE PARA ENTRADA E CONSUMAÇÃO DENTRO DO WINE GARDEN.\n\n \
                    # VALOR UNITARIO DO VOUCHER DE R$ 50,00.\n\n \
            ...
            return '# VOUCHER VÁLIDO PARA A TROCA DE UM VINHO PIZZATO CABERNET SAUVIGNON \n\n \
                    # A TROCA É REALIZADA NA SALA DE VENDAS'
        elif self.Brinde == 'BG - ESPUMANTE PIZZATO - BRANCO':
            return '# VOUCHER VÁLIDO PARA A TROCA DE UM ESPUMANTE PIZZATO BRANCO \n\n \
                    # A TROCA É REALIZADA NA SALA DE VENDAS'
