...
#        ('CANELA - CATEDRAL', 'CANELA - CATEDRAL'),
    ...
    BRINDE_CHOICES = [
        ...
        ('GM - FOTO DIGITAL LOJA FOREVER IN GRAMADO - RELOGIO DE LONDRES', 'GM - FOTO DIGITAL LOJA FOREVER IN GRAMADO - RELOGIO DE LONDRES'),
    ...
    def descricao_brinde1(self):
        ...
        elif self.Brinde == 'GM - FOTO DIGITAL LOJA FOREVER IN GRAMADO - RELOGIO DE LONDRES':
            return 'teste'
